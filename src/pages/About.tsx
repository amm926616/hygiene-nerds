    ...
    <div className="bg-gradient-to-b from-blue-50 to-white">
      <div className="container mx-auto px-6 py-16 max-w-4xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          {[
            {
              icon: <Leaf size={40} className="text-green-500 mb-4" />,
              title: "Eco-Conscious",
              description:
                "Sustainable options that care for you and the planet",
            },
            {
              icon: <HeartHandshake size={40} className="text-pink-500 mb-4" />,
              title: "Customer First",
              description: "Your satisfaction is our top priority",
            },
            {
              icon: <ShieldCheck size={40} className="text-blue-500 mb-4" />,
              title: "Quality Guaranteed",
              description: "Rigorously tested for safety and effectiveness",
            },
            {
              icon: <Sparkles size={40} className="text-yellow-500 mb-4" />,
