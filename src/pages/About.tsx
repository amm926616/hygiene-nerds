  ...
  return (
    <div className="container mx-auto px-6 py-12 max-w-3xl text-center">
      ...
      <p className="text-lg text-gray-700 leading-relaxed">
        ...
        We believe that personal care should be effortless, affordable, and accessible to everyone.
        Our mission is to provide premium hygiene solutions that keep you fresh, confident, and protected—every day.
      </p>
      <p className="mt-4 text-gray-700">
        From skincare essentials to sanitization must-haves, we curate only the best for you.
        Your well-being is our top priority, and we’re committed to ensuring excellence in every product we offer.
      </p>
      <div className="mt-8">
        <a
          href="/products"
